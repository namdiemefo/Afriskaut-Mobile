...
class NationAdapter(context: Context, private var country: ArrayList<String>, private var itemClickListener: ItemClickListener): RecyclerView.Adapter<NationAdapter.NationViewHolder>() {
...
//        holder.teamFrame.setOnClickListener{ itemClickListener.onItemClicked(id)}
        ...
        val nation = country[position]
        holder.teamName.text = nation
        holder.teamFrame.setOnClickListener { itemClickListener.onNationItemClicked(nation) }
    }
    ...
    interface ItemClickListener {
        ...
        fun onNationItemClicked(name: String)
    }
}