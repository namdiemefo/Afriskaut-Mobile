...
data class FollowingData(
    ...
    companion object CREATOR : Parcelable.Creator<FollowingData> {
        override fun createFromParcel(parcel: Parcel): FollowingData {
            return FollowingData(parcel)
        }

        override fun newArray(size: Int): Array<FollowingData?> {
